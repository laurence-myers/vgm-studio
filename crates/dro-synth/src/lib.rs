...
pub use cores::{Ay8910, GbDmg, NesApu, Sn76489};
...
pub enum AudioSource {
    Opl(std::sync::Arc<dro_core::Song>),
    Vgm(std::sync::Arc<dro_core::VgmFile>),
}
...
impl AudioSource {
    ...
    #[must_use]
    pub fn opl(&self) -> Option<&std::sync::Arc<dro_core::Song>> {
        match self {
