...
| `dro-cores-gpl` | `ym2413.nuked` — Nuked-OPLL; `sn76489.nuked-psg` — Nuked-PSG; `ym2151.lle` — YM2151-LLE (render/oracle only) | **GPL-2.0-or-later.** Neither `dro-synth` nor `dro-cores-nuked` may carry it without becoming something else. |
