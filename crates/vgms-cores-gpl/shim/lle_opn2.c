...
size_t vgms_fmopna2612_sizeof(void) { return sizeof(fmopna_2612_t); }
size_t vgms_fmopna2612_alignof(void) {
...
void vgms_fmopna2612_set_pins(fmopna_2612_t *chip, int ic, int cs, int wr,
...
int vgms_fmopna2612_out_mol(const fmopna_2612_t *chip) {
	return chip->o_mol;
}
int vgms_fmopna2612_out_mor(const fmopna_2612_t *chip) {
	return chip->o_mor;
}
