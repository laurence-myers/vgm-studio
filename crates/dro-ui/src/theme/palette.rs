...
const NAVY_CASE: CaseColors = CaseColors {
    ...
    wf_loop: Color32::from_rgb(0xFF, 0x6B, 0x6B),
...
const CREAM_CASE: CaseColors = CaseColors {
    ...
    wf_cursor: Color32::from_rgb(0xF2, 0xC7, 0x66),
    wf_loop: Color32::from_rgb(0xF0, 0x6B, 0xA0),
...
const VERDIGRIS_CASE: CaseColors = CaseColors {
    ...
    wf_cursor: Color32::from_rgb(0x7F, 0xD4, 0xE8),
    wf_loop: Color32::from_rgb(0xE8, 0xD2, 0x4C),
...
const MOSS_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0xF0, 0xB2, 0x6E),
    data_label: rgb(0xBE, 0xD4, 0xB2),
    scope: (rgb(0x0B, 0x14, 0x08), rgb(0x8F, 0xD0, 0xE8), rgb(0xE8, 0x6B, 0xA0)),
...
const PLUM_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0xC8, 0xE8, 0x6E),
    data_label: rgb(0xCC, 0xBC, 0xD6),
    scope: (rgb(0x14, 0x0C, 0x18), rgb(0xF2, 0xA0, 0xD0), rgb(0x7F, 0xD4, 0xE8)),
...
const RUST_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0x74, 0xD6, 0xE8),
    data_label: rgb(0xDC, 0xC2, 0xB0),
    scope: (rgb(0x16, 0x0C, 0x06), rgb(0xF2, 0xC7, 0x66), rgb(0xC0, 0x8C, 0xE8)),
...
const SLATE_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0xF0, 0xC8, 0x78),
    data_label: rgb(0xC2, 0xCA, 0xD4),
    scope: (rgb(0x0B, 0x0F, 0x16), rgb(0x7F, 0xD4, 0xE8), rgb(0xF0, 0x6B, 0x8A)),
...
const OLIVE_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0xC6, 0xA6, 0xF0),
    data_label: rgb(0xD4, 0xD4, 0xB0),
    scope: (rgb(0x11, 0x11, 0x0A), rgb(0xF2, 0xC7, 0x66), rgb(0x7F, 0xD4, 0xE8)),
...
const WINE_CASE: CaseColors = dark_plate_case! {
    ...
    ink: rgb(0x7F, 0xE0, 0xB8),
    data_label: rgb(0xD8, 0xBC, 0xC4),
    scope: (rgb(0x16, 0x0A, 0x10), rgb(0xF2, 0xC7, 0x66), rgb(0x8F, 0xD0, 0xE8)),
