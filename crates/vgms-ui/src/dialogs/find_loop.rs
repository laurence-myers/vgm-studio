...
//! dialog runs [`vgms_core::find_loops`] in the background (so a long song does
...
impl LoopSearchDoc {
    ...
    pub fn from_vgm(file: &vgms_core::VgmFile) -> Self {
        ...
        for index in 0..stream.len() {
            row_ms.push(vgms_core::util::smp_to_ms(
        ...
        Self {
            row_ms,
            total_commands,
            total_secs: total as f32 / vgms_core::vgm::VGM_SAMPLE_RATE as f32,
            can_store_loop: true,
        }
    }
