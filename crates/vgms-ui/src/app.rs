...
impl VgmStudioApp {
                ...
                .show(ui, |ui| {
                    theme::deck_panel(ui, p, |ui| {
                        ...
                        let opl_can_pan = self.output_renders_samples()
                            && vgms_synth::registry().pan_capable(vgms_core::vgm::ChipKind::Ymf262);
    ...
    /// (the "Measure" button).
    fn handle_volume_scan(&mut self, peak: vgms_synth::Peak) {
    ...
    fn handle_loop_candidates(&mut self, candidates: Vec<vgms_core::Candidate>) {
    ...
    fn handle_pack_peaks(&mut self, peaks: Vec<(String, vgms_synth::Peak)>) {
    ...
    fn resample_mode(&self) -> vgms_synth::resample::ResampleMode {
