...
type BenchRow = (ChipKind, u32, fn() -> Box<dyn vgms_synth::ChipCore>, f64);
...
fn the_shipping_cores_match_the_die() {
    ...
    let bench: [BenchRow; 3] = [
        (
            ChipKind::Ym2151,
            64,
            || Box::new(vgms_cores_gpl::Ym2151Lle::new()),
            0.90,
        ),
        ...
        (
            ChipKind::Ym2612,
            144,
            || Box::new(vgms_cores_gpl::Ym2612Lle::new()),
            0.90,
        ),
        ...
        (
            ChipKind::Ym2608,
            144,
            || Box::new(vgms_cores_gpl::Ym2608Lle::new()),
            0.50,
        ),
    ];
