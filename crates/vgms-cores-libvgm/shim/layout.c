...
size_t vgms_libvgm_devinfo_off_dataptr(void) { return offsetof(DEV_INFO, dataPtr); }
size_t vgms_libvgm_devinfo_off_samplerate(void) { return offsetof(DEV_INFO, sampleRate); }
size_t vgms_libvgm_devinfo_off_devdef(void) { return offsetof(DEV_INFO, devDef); }
size_t vgms_libvgm_devinfo_off_linkdevcount(void) { return offsetof(DEV_INFO, linkDevCount); }
size_t vgms_libvgm_devinfo_off_linkdevs(void) { return offsetof(DEV_INFO, linkDevs); }

size_t vgms_libvgm_devdef_off_start(void) { return offsetof(DEV_DEF, Start); }
size_t vgms_libvgm_devdef_off_stop(void) { return offsetof(DEV_DEF, Stop); }
size_t vgms_libvgm_devdef_off_reset(void) { return offsetof(DEV_DEF, Reset); }
size_t vgms_libvgm_devdef_off_update(void) { return offsetof(DEV_DEF, Update); }
size_t vgms_libvgm_devdef_off_rwfuncs(void) { return offsetof(DEV_DEF, rwFuncs); }

size_t vgms_libvgm_gencfg_off_srmode(void) { return offsetof(DEV_GEN_CFG, srMode); }
size_t vgms_libvgm_gencfg_off_flags(void) { return offsetof(DEV_GEN_CFG, flags); }
size_t vgms_libvgm_gencfg_off_clock(void) { return offsetof(DEV_GEN_CFG, clock); }
size_t vgms_libvgm_gencfg_off_smplrate(void) { return offsetof(DEV_GEN_CFG, smplRate); }
