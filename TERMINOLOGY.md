...
| **solo** ⚠ | v | Chip solo (lamp right-click) is *exclusive* across chips -- soloing one clears the rest, and un-mutes it; channel solo (toggle right-click) is *exclusive* within a chip. One word, two mechanics — say which. | [chip_channels.rs:74](crates/vgms-ui/src/widgets/chip_channels.rs) |
